...
const CalendarContent: React.FC = () => {
    ...
    const colorPalette = [
        "#9ad0ec", "#f9b5ac", "#b6e2a1", "#ffe066", "#bdb2ff", "#ffafcc",
        "#ffd6a5", "#cdb4db", "#a1cfff", "#caffbf", "#b5ead7", "#fdffb6",
        "#f8edeb", "#d0f4de", "#f6c6ea", "#e2f0cb", "#f3d1f4", "#c1cfff",
        "#fdc5f5", "#c2dfe3", "#d3f8e2", "#f9f9c5", "#aec6cf", "#d6d1b1",
        "#f4b393", "#b4d8e7", "#c2b9b0", "#f1c0e8", "#ffe5d9", "#d4a5a5"
    ];
